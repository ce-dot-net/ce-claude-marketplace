...
- ace-cli/ace-cli search, status, patterns, top, get-playbook, doctor
- ace-cli/ace-cli tune (read config)

Auto-denies dangerous destructive commands:
- ace-cli/ace-cli clear (requires explicit user confirmation)
